...
NUMERACIÓN (migration-numbering-worktrees): se desarrolló como `0027_identidades` sobre 0026 (cabeza
de `main` al crear el worktree). Al mergear, `main` ya había avanzado a 0028 (hackathones), también
sobre 0026 → para mantener una cabeza lineal única se RE-ENCADENÓ acá: `0029_identidades` sobre 0028.
El revision id lleva sufijo descriptivo (no `"0029"` pelado) para no chocar con futuros worktrees que
reclamen el mismo número (p. ej. el substrato de relaciones, aún sin mergear).
"""

...
def evidence_signature(inbox_ids: Iterable[int]) -> str:
    ...
    La usan los veredictos TERMINALES (confirm/reject), el memo `dejar` de la fase de confirmación
    por-mensaje y el reporte de staleness, que compara contra sigs guardadas: la fórmula no debe
    cambiar."""

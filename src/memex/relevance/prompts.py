...
GATE_SYSTEM_PROMPT = (
    ...
    "(transacciones/recibos con monto, eventos a los que asiste, trámites, viajes, mensajes de "
    "PERSONAS dirigidos a él) — O una OPORTUNIDAD CONCRETA que encaje con un interés (empleo, "
    "beca, evento, hackathon) o una novedad/lanzamiento de una herramienta que el usuario USA. "
    "La publicidad NO es relevant por mencionar un tema de pasada: solo si es una oferta concreta "
    "sobre algo que usa o le sirve de verdad. UMBRAL DE SIGNIFICANCIA: lo MENOR, trivial o muy "
    ...
    "- `not_relevant`: publicidad/promoción genérica que no encaja con un interés concreto; Y las "

"""Agrupado del work-set en ventanas de resumen (ADR-003: ventanas conversacionales).
...
class WorkRow:
    """Un mensaje clasificado pendiente de resumir."""
...
@dataclass(frozen=True)
class Window:
    """Un conjunto de mensajes que se resumen juntos en una llamada."""
